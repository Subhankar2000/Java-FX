package com.subhankar.karmakar.temp;
...
public class MyMain extends Application {
	...
	public static void aboutApp() {
		...
		alertDialog.setHeaderText("Created using JAVAFX !");
		alertDialog.setContentText("Simple Desktop App which helps in converting Temperatures\n not a big project but sill a medium sized project \n ;-P");
